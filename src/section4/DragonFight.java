...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		String playerattack = JOptionPane.showInputDialog("Do you want to attack the dragon with a yell or kick?");
		...
		dragonHealth -= dragonDamage;
			...
			if(playerHealth < 0) {
				...
				JOptionPane.showMessageDialog(null, "you have taken a ton of gold");
			}
